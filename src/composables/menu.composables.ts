      ...
      items: keepPresent([
        keepWithChildren({
          ...
          children: keepPresent([
            ...
            fromRoute({ name: 'pop.monitoringRoomMonthly' }),
            fromRoute({ name: 'pop.monitoringEquipments' }),
            fromRoute({ name: 'pop.monitoringEquipmentsMonthly' }),
            ...
            fromRoute({ name: 'pop.maintenanceEquipmentsMonthly' }),
            fromRoute({ name: 'pop.productionProcess' }),
            fromRoute({ name: 'pop.productionProcessDaily' }),
