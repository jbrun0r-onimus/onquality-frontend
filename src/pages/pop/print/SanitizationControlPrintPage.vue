  ...
  <div class="pop-print" v-if="data">
    <div class="form-header">
      ...
      <div class="form-title-block">
        ...
        <div class="form-subtitle">Frequência: Semestral — CONTROLE DE HIGIENIZAÇÃO</div>
      </div>
...
const questions = ['Validade da solução'];
...
onMounted(async () => {
  ...
  data.value = await getSanitizationControl(id);
