...
import { getMonitoringRoom } from 'src/services/pop/monitoringRoom.service';
import type { MonitoringRoomDetail } from 'src/schemas/pop/monitoringRoom.schemas';

const route = useRoute();
const data = ref<MonitoringRoomDetail | null>(null);
...
onMounted(async () => {
  ...
  data.value = await getMonitoringRoom(id);
